...
class AnimalFactory():
    ...
    @classmethod
    def create_animal(cls, animal: str, name: str, number: int):
        # match animal:
        #     case cls.BIRD:
        #         return Bird(name, number)
        #     case cls.FISH:
        #         return Fish(name, number)
        #     case cls.MAMMAL:
        #         return Mammal(name, number)
        if animal == cls.BIRD:
                return Bird(name, number)
        elif animal == cls.FISH:
                return Fish(name, number)
        elif animal == cls.MAMMAL:
                return Mammal(name, number)
        else:
